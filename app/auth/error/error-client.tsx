...
const errorMap = {
    [Error.Configuration]: {
        ...
        description: "There is a problem with the server configuration. This is usually due to missing environment variables (like AUTH_SECRET) or database connection issues.",
    },
    [Error.AccessDenied]: {
        title: "Access Denied",
